...
function Bart(){
    ...
    Poller.prototype.testpoll = function(url){
        ...
        rc.get("bart:dbrk:1347519094049", function(err,data){
            self._handleData(err,JSON.parse(data));
        });
    }

    /**
     *  Sets a poll interval and calls _getData
     ...
     *  @returns null
     */
    Poller.prototype._handleData = function(err,data){
        var self = this;
...
/**
 *  Set your own polling interval, in seconds.
 *  I chose seconds to discourage crazy polling intervals.
 *  It's a public service, let's be nice.
